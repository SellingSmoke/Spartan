...
export var TASKS: Task[] = [
  ...
  { id: 2, name: "Recorrido", goal_id: 4, completed: false, description: "Esta tarea hay que hacerla de este modo", type: 1, objective1:5, format1:"Km", result1: 5, objective2:20, format2:"minutos", result2:18 },
  { id: 3, name: "Recorrido", goal_id: 1, completed: true, description: "Esta tarea hay que hacerla de este modo", type: 1, objective1:5, format1:"Km", result1: 5, objective2:20, format2:"minutos", result2:18 },
  { id: 4, name: "Recorrido", goal_id: 1, completed: false, description: "Esta tarea hay que hacerla de este modo", type: 1, objective1:5, format1:"Km", result1: 5, objective2:20, format2:"minutos", result2:18 },
  { id: 5, name: "Recorrido", goal_id: 1, completed: true, description: "Esta tarea hay que hacerla de este modo", type: 1, objective1:5, format1:"Km", result1: 5, objective2:20, format2:"minutos", result2:18 },
  { id: 5, name: "Recorrido", goal_id: 1, completed: false, description: "Esta tarea hay que hacerla de este modo", type: 1, objective1:5, format1:"Km", result1: 5, objective2:20, format2:"minutos", result2:18 }
];
